...
Matrix4x4::Matrix4x4(Vector4 col1, Vector4 col2, Vector4 col3, Vector4 col4)
{
...
Vertex Matrix4x4::operator*(Vertex v)
{
...
Matrix4x4 Matrix4x4::TranslateMatrix(Vector3 v)
{
	return Matrix4x4(Vector4(1, 0, 0, 0), Vector4(0, 1, 0, 0), Vector4(0, 0, 1, 0), Vector4(v.x, v.y, v.z, 1));
}

Matrix4x4 Matrix4x4::InverseTranslateMatrix(float x, float y, float z)
{
	return Matrix4x4(Vector4(1, 0, 0, 0), Vector4(0, 1, 0, 0), Vector4(0, 0, 1, 0), Vector4(-x, -y, -z, 1));
}

Matrix4x4 Matrix4x4::InverseTranslateMatrix(Vector3 v)
{
	return Matrix4x4(Vector4(1, 0, 0, 0), Vector4(0, 1, 0, 0), Vector4(0, 0, 1, 0), Vector4(-v.x, -v.y, -v.z, 1));
}

Matrix4x4 Matrix4x4::XRotateMatrix(float degree)
{
...
Matrix4x4 Matrix4x4::YRotateMatrix(float degree)
{
...
Matrix4x4 Matrix4x4::ZRotateMatrix(float degree)
{
...
Matrix4x4 Matrix4x4::InverseXRotateMatrix(float degree)
{
...
Matrix4x4 Matrix4x4::InverseYRotateMatrix(float degree)
{
...
Matrix4x4 Matrix4x4::InverseZRotateMatrix(float degree)
{
...
Matrix4x4 Matrix4x4::YXZRotateMatrix(Vector3 rotation)
{
	return  YRotateMatrix(rotation.y) * XRotateMatrix(rotation.x) * ZRotateMatrix(rotation.z);
}

Matrix4x4 Matrix4x4::InverseYXZRotateMatrix(Vector3 rotation)
{
